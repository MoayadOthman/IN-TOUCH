...
import 'package:intouch/features/presentation/page/profile/widgets/profile_form_widget.dart';
...
class _UploadPostMainWidgetState extends State<UploadPostMainWidget> {
  ...
  Widget build(BuildContext context) {
    return _image == null? _uploadPostWidget() : Scaffold(
      resizeToAvoidBottomInset: true,  // تفعيل هذه الخاصية لتجنب تداخل الكيبورد مع المحتوى
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(  // التأكد من أن كل المحتوى قابل للتمرير
          child: Column(
            children: [
              Container(
                width: 80,
